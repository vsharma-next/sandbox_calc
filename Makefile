...
VENV_NAME ?= sandbox_calc#OPT Name of conda virtual environment (overridden by VENV_DIR)

# Default values used below (caution: keep values in sync with above)
DEFAULT_VENV_NAME = sandbox_calc#
...
#	\rm -f docs/sandbox_calc.rst
#	\rm -f docs/modules.rst
#	${PREFIX}sphinx-apidoc -o docs/ src/sandbox_calc
